...
CREATE TABLE IF NOT EXISTS `tasksapidb`.`projects` (
  ...
  `createdAt` DATETIME NULL DEFAULT NULL COMMENT 'DATETIME in UTC',
  `updatedAt` DATETIME NULL DEFAULT NULL COMMENT 'DATETIME in UTC',
...
CREATE TABLE IF NOT EXISTS `tasksapidb`.`assigns` (
  ...
  `assignDate` DATETIME NULL DEFAULT NULL COMMENT 'DATETIME in UTC',
...
CREATE TABLE IF NOT EXISTS `tasksapidb`.`attachments` (
  ...
  `applicationUser` VARCHAR(250) NOT NULL,
  `userName` VARCHAR(250) NOT NULL,
  `uploadedAt` DATETIME NULL DEFAULT NULL,
  `deleted` TINYINT(4) NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `identifier_UNIQUE` (`identifier` ASC))
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `tasksapidb`.`configurations` (
  ...
  `configurationLabel` VARCHAR(250) NULL DEFAULT NULL,
  `configurationValue` VARCHAR(250) NOT NULL,
  `description` VARCHAR(500) NULL DEFAULT NULL,
  `color` VARCHAR(250) NULL DEFAULT NULL COMMENT 'The UI may need to show the color of the configuration. The values that we can provide are in this format #40CB3BFF.',
  `icon` VARCHAR(250) NULL DEFAULT NULL COMMENT 'The UI may need to show an icon for the configuration. The value can be a URI of the icon.',
  `createdAt` DATETIME NULL DEFAULT NULL COMMENT 'DATETIME in UTC',
  `updatedAt` DATETIME NULL DEFAULT NULL COMMENT 'DATETIME in UTC',
  `weight` INT(11) NULL DEFAULT NULL COMMENT 'This field is used for sorting reason',
  `applicationUser` VARCHAR(250) NULL DEFAULT NULL,
  `projects_id` BIGINT(20) NOT NULL,
  PRIMARY KEY (`id`),
